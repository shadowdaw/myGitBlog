...
也有一些明显的例外：轻量级的销售引导页（完全放弃框架），3D游戏，AR/VR。对于3D内容，看看[Unity](https://unity3d.com/cn/), [Unreal](https://www.unrealengine.com/en-US/what-is-unreal-engine-4),或者[PlayCanvas](https://playcanvas.com/)。也就是说React也可以用于3D内容UI。 
